...
function (_React$Component) {
  ...
  _createClass(Weather, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, " Shiba Weather Widget "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "weather flex"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, this.state.city)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, this.state.temp, " F"))));
    }
  }, {
    key: "componentWillMount",
    value: function componentWillMount() {
      ...
      navigator.geolocation.getCurrentPosition(function (position) {
        _this2.weatherRequest(position.coords.latitude, position.coords.longitude);
      });
    }
  }, {
    key: "buildURL",
    value: function buildURL(lat, lng) {
      var key = "APPID=60c2b1cffd988f585be5353d9b02639d";
      var url = "https://api.openweathermap.org/data/2.5/weather?";
      var units = "units=imperial";
      var loc = "lat=".concat(lat, "&lon=").concat(lng, "&");
      return "".concat(url).concat(loc, "&").concat(units, "&").concat(key);
    }
  }, {
    key: "weatherRequest",
    value: function weatherRequest(lat, lng) {
